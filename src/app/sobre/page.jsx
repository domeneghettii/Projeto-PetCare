...
export default function Sobre() {
  return (
    <div className="card">
      ...
      <p>Olá! Sou Luana Domeneghetti, estudante de Medicina Veterinária, motivada pelo cuidado com animais e pelo desejo de unir tecnologia e bem-estar animal. Tenho trabalhado com Next.js, React, HTML, CSS e JavaScript, criando sistemas para gerenciamento de pets, e aprendi muito sobre front-end, back-end, organização e trabalho em equipe.</p>
